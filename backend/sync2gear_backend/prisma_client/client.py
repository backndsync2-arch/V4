...
SCHEMA_PATH = Path('C:/Users/Bhavin/OneDrive/Desktop/Music-Shervin/V4/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Bhavin\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    track: 'actions.TrackActions[models.Track]'
    schedule: 'actions.ScheduleActions[models.Schedule]'
    announcement: 'actions.AnnouncementActions[models.Announcement]'
    playlog: 'actions.PlayLogActions[models.PlayLog]'
    ...
    def __init__(
        ...
        *,
        ...
        self.track = actions.TrackActions[models.Track](self, models.Track)
        self.schedule = actions.ScheduleActions[models.Schedule](self, models.Schedule)
        self.announcement = actions.AnnouncementActions[models.Announcement](self, models.Announcement)
        self.playlog = actions.PlayLogActions[models.PlayLog](self, models.PlayLog)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/Bhavin/OneDrive/Desktop/Music-Shervin/V4/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    track: 'TrackBatchActions'
    schedule: 'ScheduleBatchActions'
    announcement: 'AnnouncementBatchActions'
    playlog: 'PlayLogBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.track = TrackBatchActions(self)
        self.schedule = ScheduleBatchActions(self)
        self.announcement = AnnouncementBatchActions(self)
        self.playlog = PlayLogBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class AnnouncementBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

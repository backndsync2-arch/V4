...
export function CancellationPolicy({ onBack }: CancellationPolicyProps) {
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-24 md:pb-6 p-4">
      {/* Back Button */}
      {onBack && (
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                <Badge variant="outline">Last Updated: January 20, 2026</Badge>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">1.1 In this Policy:</p>
            <ul className="space-y-2 ml-4">
              <li><strong>"Company", "We", "Us", "Our"</strong> means sync2gear Limited, registered in England and Wales</li>
              <li><strong>"Customer", "You", "Your"</strong> means the business entity or individual who has entered into a Service Agreement</li>
              <li><strong>"Service Agreement"</strong> means the binding contract for provision of sync2gear services</li>
              <li><strong>"Subscription Period"</strong> means the recurring billing cycle (monthly or annual) selected by Customer</li>
              <li><strong>"Service Commencement Date"</strong> means the date on which access to the Platform is first provided</li>
              <li><strong>"Platform"</strong> means the sync2gear software application and associated services</li>
              <li><strong>"Content"</strong> means all data, music files, announcements, schedules, and configurations uploaded by Customer</li>
              <li><strong>"Device(s)"</strong> means hardware units registered to Customer's account for audio playback</li>
              <li><strong>"Notice Period"</strong> means the period specified in Section 3 for termination notification</li>
            </ul>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">2.1 Minimum Term</p>
          ...
          <div>
            <p className="font-semibold mb-2">2.2 Automatic Renewal</p>
          ...
          <div>
            <p className="font-semibold mb-2">2.3 Payment Terms</p>
          ...
          <div>
            <p className="font-semibold mb-2">2.4 Device Add-ons</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">3.1 Notice Period</p>
          ...
          <div>
            <p className="font-semibold mb-2">3.2 Method of Cancellation</p>
            ...
            <p className="mt-2 text-amber-800 bg-amber-50 p-3 rounded">
              <strong>Important:</strong> Verbal cancellation requests, social media messages, or requests to support staff 
              via chat do NOT constitute valid cancellation notice.
            </p>
          </div>
          <div>
            <p className="font-semibold mb-2">3.3 Cancellation Confirmation</p>
          ...
          <div>
            <p className="font-semibold mb-2">3.4 Cancellation During Minimum Term</p>
          ...
          <div>
            <p className="font-semibold mb-2">3.5 No Cancellation of Device Purchases</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">4.1 Service Continuation</p>
          ...
          <div>
            <p className="font-semibold mb-2">4.2 Access Termination</p>
          ...
          <div>
            <p className="font-semibold mb-2">4.3 No Partial Month Credits</p>
          ...
          <div>
            <p className="font-semibold mb-2">4.4 Outstanding Obligations</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">5.1 No Refunds Policy</p>
            <p className="bg-slate-100 p-3 rounded border border-slate-300 font-semibold">
              All subscription fees are strictly non-refundable except as expressly provided in Sections 5.2, 5.3, and 5.4 below.
            </p>
          </div>
          <div>
            <p className="font-semibold mb-2">5.2 Money-Back Guarantee (New Customers Only)</p>
          ...
          <div>
            <p className="font-semibold mb-2">5.3 Service Failure Refunds</p>
          ...
          <div>
            <p className="font-semibold mb-2">5.4 Erroneous Billing</p>
          ...
          <div>
            <p className="font-semibold mb-2">5.5 Refund Processing</p>
          ...
          <div>
            <p className="font-semibold mb-2">5.6 No Refunds For</p>
            <ul className="list-disc ml-6 mt-2 space-y-1">
      ...
      <Card>
        <CardHeader>
          <CardTitle>6. Data Retention & Export Upon Cancellation</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">6.1 Data Export Period</p>
          ...
          <div>
            <p className="font-semibold mb-2">6.2 Data Deletion</p>
            ...
            <p className="mt-2 bg-red-50 border border-red-200 p-3 rounded text-red-900">
              <strong>Warning:</strong> Data deletion is automatic and irreversible. We do not maintain backups of cancelled accounts. 
              Customer is solely responsible for exporting all required data before the deletion deadline.
            </p>
          </div>
          <div>
            <p className="font-semibold mb-2">6.3 Retained Information</p>
          ...
          <div>
            <p className="font-semibold mb-2">6.4 Reactivation</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>7. Downgrades & Plan Modifications</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">7.1 Downgrade Option</p>
          ...
          <div>
            <p className="font-semibold mb-2">7.2 Feature Restrictions</p>
          ...
          <div>
            <p className="font-semibold mb-2">7.3 Annual to Monthly Conversion</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>8. Account Suspension (Alternative to Cancellation)</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">8.1 Temporary Suspension Option</p>
          ...
          <div>
            <p className="font-semibold mb-2">8.2 Suspension Limitations</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>9. Termination by sync2gear</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">9.1 Termination for Breach</p>
          ...
          <div>
            <p className="font-semibold mb-2">9.2 Service Discontinuation</p>
          ...
          <div>
            <p className="font-semibold mb-2">9.3 No Liability</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>10. Payment Disputes & Chargebacks</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">10.1 Dispute Resolution</p>
          ...
          <div>
            <p className="font-semibold mb-2">10.2 Chargeback Consequences</p>
          ...
          <div>
            <p className="font-semibold mb-2">10.3 Legal Costs</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>11. Governing Law & Jurisdiction</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">11.1 Governing Law</p>
          ...
          <div>
            <p className="font-semibold mb-2">11.2 Jurisdiction</p>
          ...
          <div>
            <p className="font-semibold mb-2">11.3 Consumer Rights (UK/EU Customers)</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>12. Policy Modifications</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">12.1 Right to Modify</p>
          ...
          <div>
            <p className="font-semibold mb-2">12.2 Acceptance of Changes</p>
          ...
          <div>
            <p className="font-semibold mb-2">12.3 Grandfathering</p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <p className="font-semibold mb-2">For Cancellation Requests:</p>
            <p>Email: <a href="mailto:cancellations@sync2gear.com" className="text-blue-600 underline">cancellations@sync2gear.com</a></p>
          </div>
          <div>
            <p className="font-semibold mb-2">For Refund Requests:</p>
            <p>Email: <a href="mailto:refunds@sync2gear.com" className="text-blue-600 underline">refunds@sync2gear.com</a></p>
          </div>
          <div>
            <p className="font-semibold mb-2">For Billing Disputes:</p>
            <p>Email: <a href="mailto:billing@sync2gear.com" className="text-blue-600 underline">billing@sync2gear.com</a></p>
          </div>
          <div>
            <p className="font-semibold mb-2">Postal Address:</p>
            <p>
          ...
          <div>
            <p className="font-semibold mb-2">Company Registration:</p>
      ...
      <Card className="border-slate-300 bg-slate-50">
        <CardContent className="pt-6">
          <div className="text-sm text-slate-700">
            <p className="font-semibold mb-3">ACKNOWLEDGMENT</p>
            <p className="mb-3">

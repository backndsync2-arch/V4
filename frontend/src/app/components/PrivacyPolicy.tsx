            ...
            <ScrollArea className="h-[70vh]">
              <div className="space-y-6 pr-4 text-gray-300">
                ...
                <section>
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4 text-white">1.1 Account Information</h3>
                  <p className="text-gray-300 leading-relaxed">When you create an account, we collect:</p>
                  ...
                  <p className="text-gray-300 leading-relaxed">When you use the Service, we store:</p>
                  <ul className="list-disc list-inside text-gray-300 space-y-2 mt-2 ml-4">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">3. Legal Basis for Processing (GDPR)</h2>
                  <p className="text-gray-300 leading-relaxed">Under GDPR, we process your data based on:</p>
                  <ul className="list-disc list-inside text-gray-300 space-y-2 mt-2 ml-4">
                ...
                <section>
                  ...
                  <p className="text-gray-300 leading-relaxed">We share your data with:</p>
                  ...
                  <p className="text-gray-300 leading-relaxed">We may disclose your information if required to:</p>
                  <ul className="list-disc list-inside text-gray-300 space-y-2 mt-2 ml-4">
                ...
                <section>
                  ...
                  <p className="text-gray-300 leading-relaxed">We protect your data using:</p>
                  <ul className="list-disc list-inside text-gray-300 space-y-2 mt-2 ml-4">
                ...
                <section>
                  ...
                  <p className="text-gray-300 leading-relaxed">We retain your data:</p>
                  <ul className="list-disc list-inside text-gray-300 space-y-2 mt-2 ml-4">
                ...
                {/* 7. Your Rights (GDPR) */}
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">7. Your Rights Under GDPR</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">8. Cookies and Tracking Technologies</h2>
                ...
                {/* 9. Third-Party Links */}
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">9. Third-Party Links</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">11. International Data Transfers</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">13. Contact Information</h2>
                  <p className="text-gray-300 leading-relaxed">
                  ...
                  <div className="bg-white/5 rounded-lg p-4 mt-3 border border-white/10">
                    ...
                    <p className="text-gray-300">Email: <a href="mailto:privacy@sync2gear.com" className="text-[#1db954] underline hover:text-[#1ed760]">privacy@sync2gear.com</a></p>
                    <p className="text-gray-300">Email (Support): <a href="mailto:support@sync2gear.com" className="text-[#1db954] underline hover:text-[#1ed760]">support@sync2gear.com</a></p>
                  ...
                  <p className="text-gray-300 leading-relaxed mt-3">
                    <strong className="text-white">UK Information Commissioner's Office (ICO):</strong><br />
                    If you are not satisfied with our response, you can complain to the ICO at <a href="https://www.ico.org.uk" className="text-[#1db954] underline hover:text-[#1ed760]">www.ico.org.uk</a>
                  </p>
                </section>

                {/* Summary */}
                <section className="bg-[#1db954]/20 rounded-lg p-4 border border-[#1db954]/30">
                  <h3 className="font-semibold text-[#1db954] mb-2">Privacy Summary</h3>

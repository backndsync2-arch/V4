...
const tutorialSteps: TutorialStep[] = [
  {
    ...
    icon: <Music className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600" />,
    content: (
      <div className="text-center space-y-2 sm:space-y-3 text-sm sm:text-base leading-relaxed">
  ...
  },
  {
    ...
    icon: <Play className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600" />,
    content: (
      <div className="text-center space-y-2 sm:space-y-3 text-sm sm:text-base leading-relaxed">
  ...
  },
  {
    ...
    icon: <Grid3x3 className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600" />,
    content: (
      <div className="text-center space-y-2 sm:space-y-3 text-sm sm:text-base leading-relaxed">
  ...
  },
  {
    ...
    icon: <Radio className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600" />,
    content: (
      <div className="text-center space-y-2 sm:space-y-3 text-sm sm:text-base leading-relaxed">
  ...
  },
  {
    ...
    icon: <Volume2 className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600" />,
    content: (
      <div className="text-center space-y-2 sm:space-y-3 text-sm sm:text-base leading-relaxed">
...
export function Tutorial({ onComplete }: TutorialProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="w-[92vw] max-w-lg sm:max-w-xl max-h-[85vh] overflow-y-auto p-4 sm:p-6">
        <DialogHeader>
          ...
          <DialogTitle className="text-lg sm:text-xl text-center">{step.title}</DialogTitle>
            ...
            <ul className="space-y-2">
              {step.tips.map((tip, index) => (
                <li key={index} className="flex items-start gap-2 text-xs sm:text-sm">
                  <div className="h-1.5 w-1.5 rounded-full bg-blue-600 mt-1.5 sm:mt-2 shrink-0" />
                  <span>{tip}</span>
                </li>
              ))}
            </ul>

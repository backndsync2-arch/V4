                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {(!audio.url || audio.url === '#' || audio.url === '') && audio.ttsText && (
                      <Badge variant="outline" className="shrink-0 text-[10px] bg-yellow-500/20 text-yellow-400 border-yellow-500/30 px-1.5 py-0.5">
                        NO AUDIO
                      </Badge>
                    )}
                    {(!audio.url || audio.url === '#' || audio.url === '') && !audio.ttsText && (
                      <Badge variant="outline" className="shrink-0 text-[10px] bg-red-500/20 text-red-400 border-red-500/30 px-1.5 py-0.5">
                        NO VOICE
                      </Badge>
                    )}
                  </div>

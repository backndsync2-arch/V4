          ...
          <CardContent className="p-6">
            <ScrollArea className="h-[70vh]">
              <div className="space-y-6 pr-4">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3">3. Subscription Terms & Contract Period</h2>
                  
                  <h3 className="text-lg font-semibold mb-2 mt-4">3.1 Contract Duration</h3>
                  <p className="text-slate-700 leading-relaxed">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">3.2 Free Trial Period</h3>
                  <p className="text-slate-700 leading-relaxed">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">3.3 Billing & Payment</h3>
                  <p className="text-slate-700 leading-relaxed">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">3.4 Auto-Renewal</h3>
                  <p className="text-slate-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3">4. Cancellation & Termination Policy</h2>
                  
                  <h3 className="text-lg font-semibold mb-2 mt-4">4.1 Cancellation During Contract Period</h3>
                  <p className="text-slate-700 leading-relaxed">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">4.2 Cancellation After Contract Period</h3>
                  <p className="text-slate-700 leading-relaxed">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">4.3 How to Cancel</h3>
                  <p className="text-slate-700 leading-relaxed">
                    To cancel your subscription:
                  </p>
                  <ol className="list-decimal list-inside text-slate-700 space-y-2 mt-2 ml-4">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">4.4 Termination by Company</h3>
                  <p className="text-slate-700 leading-relaxed">
                  ...
                  <h3 className="text-lg font-semibold mb-2 mt-4">4.5 Data After Cancellation</h3>
                  <p className="text-slate-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3">5. AI Credits & Premium Features</h2>
                  <p className="text-slate-700 leading-relaxed">
                ...
                <section>
                  ...
                  <p className="text-slate-700 leading-relaxed">You agree to:</p>
                  <ul className="list-disc list-inside text-slate-700 space-y-2 mt-2 ml-4">
                ...
                <section>
                  ...
                  <p className="text-slate-700 leading-relaxed">You may not upload or distribute:</p>
                  <ul className="list-disc list-inside text-slate-700 space-y-2 mt-2 ml-4">
                ...
                {/* 8. Music Licensing */}
                <section>
                  <h2 className="text-xl font-semibold mb-3">8. Music Licensing Compliance</h2>
                  <p className="text-slate-700 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3">9. Service Availability & Support</h2>
                  <p className="text-slate-700 leading-relaxed">
                ...
                {/* 12. Governing Law */}
                <section>
                  <h2 className="text-xl font-semibold mb-3">12. Governing Law & Disputes</h2>
                  <p className="text-slate-700 leading-relaxed">
                ...
                <section>
                  ...
                  <div className="bg-slate-50 rounded-lg p-4 mt-3 border">
                    ...
                    <p className="text-slate-600">Email: support@sync2gear.com</p>
                ...
                <section className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <h3 className="font-semibold text-blue-900 mb-2">Acceptance of Terms</h3>
